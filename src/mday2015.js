 ...
 */
  ...
  $(function () {
    ...
    $('.traditional').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote01');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card01.pdf');
    }); 
    $('.rocker').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote02');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card02.pdf');
    });
    $('.artsy').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote03');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card03.pdf');
    });
    $('.hippie').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote04');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card04.pdf');
    });
    $('.sporty').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote05');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card05.pdf');
    });
    $('.disco').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote06');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card06.pdf');
    });
    $('.savvy').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote07');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card07.pdf');
    });
    $('.globetrotter').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote08');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card08.pdf');
    });
    $('.bookworm').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote09');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card09.pdf');
    });
    $('.sweetheart').click(function(){
      $('#quote').removeClass();
      $('#quote').addClass('quote10');
      $('.card').attr('href','pdf/MDAY2015-nesseco-card10.pdf');
    });
